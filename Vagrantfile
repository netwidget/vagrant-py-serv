...
Vagrant.configure("2") do |config|
  config.vm.define :centos do |centos_config|
    centos_config.vm.box = "centos64-x64"
  ...
  config.vm.provider "virtualbox" do |v|
    v.name = "kidserv_py" # Change to VM name.
    v.memory = 2048 
  end
  ...
  # centos64-webserv.sh.
  # Mac version
  #config.vm.synced_folder "/Users/<username>/sitedev/kidwork", "/var/www/kidwork"

  # Linux version
  #config.vm.synced_folder "/home/<username>/sitedev/kidwork", "/var/www/kidwork"

  # Windows version
  config.vm.synced_folder "/Users/James/Documents/sitedev/kidwork_py", "/var/www/kidwork_py"

  # Provision with BASH
  config.vm.provision :shell, :path => "centos64-flask.sh"
end